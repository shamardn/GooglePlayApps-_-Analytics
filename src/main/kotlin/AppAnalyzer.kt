...
class AppAnalyzer {
    ...
    fun getNumberOfAppsDevelopedBySomeCompany(appsList: MutableList<App>, companyName: String) = if(appsList.isEmpty()) 0 else appsList.filter { it.company.contains(companyName) }.size
    ...
    fun getTop10InstalledApps(appsList: MutableList<App>) = if (appsList.isEmpty() || appsList.size < 10) null else appsList.sortedByDescending { it.installs }.subList(0, 10)
